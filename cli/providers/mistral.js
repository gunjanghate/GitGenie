...
export class MistralProvider extends AIProvider {
    ...
    /**
     * Generate PR title using Mistral
     */
    ...
    /**
     * Group files using Mistral AI analysis
     */
    async groupFilesWithAI(filesData, maxGroups = 5) {
        const spinner = ora('🧞 Analyzing changes with Mistral AI...').start();
...
- If scope is not applicable, use empty string ""`;
            ...
            spinner.succeed('✓ Mistral AI analysis complete');
            ...
            spinner.fail('Mistral AI analysis failed');
    ...
    /**
     * Generate commit message for a specific group using Mistral
     */
