...
export default function AmbientBackground() {
  ...
  useEffect(() => {
    ...
    function draw(now = 0) {
      ...
      ctx.globalAlpha = 0.7
      ctx.shadowColor = "rgba(0,0,0,0.16)" // black glow
      ctx.shadowBlur = 8
  ...
  return (
    <div className="pointer-events-none absolute inset-0 bg-black">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <span
          className="absolute -bottom-1/3 right-1/3 h-[50vh] w-[50vh] rounded-full bg-amber-500/10 blur-3xl will-change-transform"
